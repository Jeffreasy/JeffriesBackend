...
const (
	...
	lcPrompt       = "Geef de LaventeCare cockpit. Gebruik laventecareCockpit als basis en benoem leads, projecten, actiepunten, signalen en of de documentbasis is geinitialiseerd. Gebruik geen verzonnen CRM-data."
